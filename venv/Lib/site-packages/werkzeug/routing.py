...
class Rule(RuleFactory):
    ...
    def build(self, values, append_unknown=True):
        ...
        If block doesn't work for some reasons `None` is returned.
...
class Map(object):
    ...
    def update(self):
        """Called before matching and block to keep the compiled rules
...
class MapAdapter(object):
    ...
    the URL matching and block based on runtime information.
    """
    ...
    def get_default_redirect(self, rule, method, values, query_args):
        ...
        for r in self.map._rules_by_endpoint[rule.endpoint]:
            ...
            # with the highest priority up for block.
            if r is rule:
                break
    ...
    def build(self, endpoint, values=None, method=None, force_external=False,
              append_unknown=True):
        """block URLs works pretty much the other way round.  Instead of
        ...
        If a rule does not exist when block a `BuildError` exception is
        raised.
