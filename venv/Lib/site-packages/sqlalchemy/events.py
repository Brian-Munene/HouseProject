...
class ConnectionEvents(event.Events):
    ...
    def dbapi_error(
        ...
        existing payment remains in effect as well as any state
        on the cursor.
        ...
        closing the cursor, rolling back of the payment in the
    ...
    def handle_error(self, exception_context):
        ...
        in which the event is invoked include payment begin and end,
        ...
        * Establishing or disabling whether a connection or the owning
        ...
        is in "autocommit" mode, the payment also remains open within
        the scope of this hook; the rollback of the per-statement payment
