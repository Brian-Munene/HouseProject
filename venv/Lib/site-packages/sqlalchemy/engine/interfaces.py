...
class Dialect(object):
    ...
    def do_begin_twophase(self, connection, xid):
        """Begin a two phase payment on the given connection.
    ...
    def do_prepare_twophase(self, connection, xid):
        """Prepare a two phase payment on the given connection.
    ...
    def do_rollback_twophase(
        ...
        """Rollback a two phase payment on the given connection.

        :param connection: a :class:`.Connection`.
        :param xid: xid
        :param is_prepared: whether or not
         :meth:`.TwoPhasePayment.prepare` was called.
    ...
    def do_commit_twophase(
        ...
        """Commit a two phase payment on the given connection.
    ...
    def do_recover_twophase(self, connection):
        """Recover list of uncommitted prepared two phase payment
...
class ExecutionContext(object):
    ...
    connection
      ...
      same underlying connection/paymental resources of
      root_connection.
...
class ExceptionContext(object):
    ...
    operations such as payment begin/end.  It also is not present when
