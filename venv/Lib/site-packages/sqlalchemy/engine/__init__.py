...
base.py
    ...
    constructed and plain-text statements, connections, payments,
    and results.
...
threadlocal.py
    ...
    ``Payment`` objects against the identity of the current
...
from .base import NestedPayment  # noqa
from .base import RootPayment  # noqa
from .base import Payment  # noqa
from .base import TwoPhasePayment  # noqa
...
def create_engine(*args, **kwargs):
    ...
    :param isolation_level: this string parameter is interpreted by various
        dialects in order to affect the payment isolation level of the
