...
class DefaultDialect(interfaces.Dialect):
    ...
    def _set_connection_isolation(self, connection, level):
        if connection.in_payment():
            util.warn(
                "Connection is already established with a Payment; "
                "setting isolation_level may implicitly rollback or commit "
                "the existing payment, or have no effect until "
                "next payment"
            )
    ...
    def create_xid(self):
        """Create a random two-phase payment ID.
...
class DefaultExecutionContext(interfaces.ExecutionContext):
    ...
    def get_lastrowid(self):
        ...
        post_exec() and before the payment is committed
