...
class UOWPayment(object):
    ...
    def remove_state_actions(self, state):
        """remove pending actions for a state from the uowpayment."""
    ...
    def _generate_actions(self):
        ...
        well as dependency pairs for this UOWPayment.
    ...
    def finalize_flush_changes(self):
        ...
        execute() method has succeeded and the payment has been committed.
