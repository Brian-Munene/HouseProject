...
* ``isolation_level`` - Set the payment isolation level for the lifespan
...
Psycopg2 Payment Isolation Level
-------------------------------------
...
API-level setting is always emitted at the start of each payment in any
case.
