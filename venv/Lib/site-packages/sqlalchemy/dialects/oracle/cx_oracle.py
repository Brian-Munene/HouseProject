...
Two Phase Payments Not Supported
-------------------------------------

Two phase payments are **not supported** under cx_Oracle due to poor
driver support.   As of cx_Oracle 6.0b1, the interface for
two phase payments has been changed to be more of a direct pass-through
...
class OracleDialect_cx_oracle(OracleDialect):
    ...
    def _pop_deprecated_kwargs(self, kwargs):
        ...
        if allow_twophase is not None:
            util.warn.deprecated(
                ...
                "longer supports two-phase payment mode."
            )
    ...
    def create_xid(self):
        ...
        .. deprecated:: two-phase payment support is no longer functional
