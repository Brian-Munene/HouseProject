...
All SQL Server dialects support setting of payment isolation level
...
SQL Server has a default payment
    ...
    def get_isolation_level(self, connection):
        ...
        for view in views:
            ...
            try:
                cursor.execute(
                    """
                  SELECT CASE payment_isolation_level
                    WHEN 0 THEN NULL
            ...
            util.warn(
                "Could not fetch payment isolation level, "
